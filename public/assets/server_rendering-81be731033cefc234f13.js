...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__Menu__ = __webpack_require__(/*! ./Menu */ 7);
...
class WorkList extends __WEBPACK_IMPORTED_MODULE_0_react___default.a.Component {
  ...
  toggleBody(id, toggle) {
    let newWorks = this.state.works.findIndex(work => work.id === id ? work.openBody = toggle : null);
  ...
  modChild(id, title, body, count) {
    let newWorks = this.state.works.findIndex(work => {
      if (work.id === id) {
        work.title = title;
        work.body = body;
  ...
  async deleteChild(id) {
    let newWorks = this.state.works.splice(newWorks.findIndex(work => work.id === id), 1);
    this.setState({
      works: newWorks
    });
    const url = this.props.url + '/' + id + '.json';
  ...
  async newChild() {
    ...
    try {
      ...
      if (response.ok) {
        ...
        let newWorks = this.state.works.unshift(jsonResponse);
        this.setState({ works: newWorks });
      }
    } catch (error) {
      console.log(error);
...
var hyphenate = __webpack_require__(/*! ./hyphenate */ 30);
...
var ReactDOM = __webpack_require__(/*! react-dom */ 20)
...
var _assign = __webpack_require__(/*! object-assign */ 4);
var emptyFunction = __webpack_require__(/*! fbjs/lib/emptyFunction */ 1);
var EventListener = __webpack_require__(/*! fbjs/lib/EventListener */ 23);
...
var focusNode = __webpack_require__(/*! fbjs/lib/focusNode */ 29);
var emptyObject = __webpack_require__(/*! fbjs/lib/emptyObject */ 8);
var checkPropTypes = __webpack_require__(/*! prop-types/checkPropTypes */ 5);
...
/***/ })
/******/ ]);
//# sourceMappingURL=server_rendering-81be731033cefc234f13.js.map